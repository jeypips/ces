...
<html lang="en">
  <head>
    ...
    <title>Maritime | Students</title>
	
	<link rel="icon" type="image/ico" href="pictures/maritime-logo.png">
  ...
  <body class="nav-md" ng-app="courses" ng-controller="coursesCtrl" account-profile>
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><img src="pictures/maritime-logo.png" height="45"> <span>Maritime</span></a>
            </div>
